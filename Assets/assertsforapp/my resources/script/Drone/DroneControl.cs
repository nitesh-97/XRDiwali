...
public class DroneControl: MonoBehaviour {
	...
	void Update () {
		Rx = RButton.GetComponent<DroneCanvas> ().Rx;
		Ry = RButton.GetComponent<DroneCanvas> ().Ry;
		Lx = LButton.GetComponent<DroneCanvas> ().Lx;
		Ly = LButton.GetComponent<DroneCanvas> ().Ly;
	}
